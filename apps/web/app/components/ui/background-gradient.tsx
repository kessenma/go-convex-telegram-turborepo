    ...
    <div className={cn("relative p-[4px] group", containerClassName)}>
      <div
        className={cn(
          ...
          color === "cyan" && "bg-[radial-gradient(circle_farthest-side_at_0_100%,#48b4e8,transparent),radial-gradient(circle_farthest-side_at_100%_0,#24a1de,transparent),radial-gradient(circle_farthest-side_at_100%_100%,#137cb6,transparent),radial-gradient(circle_farthest-side_at_0_0,#106394,#0d2d44)]",
