      ...
      <Card className="w-full max-w-4xl max-h-[90vh] flex flex-col bg-white dark:bg-gray-900 shadow-2xl">
        <div className="flex justify-between items-center p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex gap-3 items-center">
            {renderIcon(MessagesSquare, {
              className: "w-6 h-6 text-curious-cyan-500",
            })}
                    ...
                    >
                      <Card
                        className={cn(
                          ...
                          isUserMessage
                            ? "bg-curious-cyan-50 dark:bg-curious-cyan-900/30"
                            : ""
                        )}
                      >
          ...
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 dark:border-gray-700 dark:bg-gray-800/50">
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div className="space-y-2">
                <div className="relative">
                  ...
                  >
                    {isLoading ? (
                      <div
                        className="w-4 h-4 rounded-full border-b-2 border-white animate-spin"
                        aria-hidden="true"
                      />
                    ) : (
                      renderIcon(Send, {
              ...
              {error && (
                <div
                  role="alert"
                  className="flex gap-2 items-center p-3 text-sm text-red-800 bg-red-50 rounded-lg border border-red-200 dark:bg-red-900/30 dark:border-red-800 dark:text-red-300"
                >
