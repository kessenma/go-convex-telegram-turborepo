...
import type { TelegramThread } from "../../models/telegram";
...
export default function ThreadsPage(): React.ReactElement {
  ...
  return (
    <div className="p-6 mx-auto max-w-6xl">
      <Hero
        title="Telegram Threads"
        subtitle={`${threads?.length || 0} active threads`}
      />
              ...
              <div className="mb-4 space-y-3">
                <div className="flex flex-wrap gap-2">
                  ...
                  {thread.creatorUsername && (
                    <span className="px-2 py-1 text-xs text-cyan-800 bg-cyan-100 rounded-full dark:bg-cyan-900 dark:text-cyan-200">
                      @{thread.creatorUsername}
                    </span>
                  )}
                </div>
