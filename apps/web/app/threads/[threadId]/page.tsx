  ...
  if (!threadId) {
    return (
      <div className="p-6 mx-auto max-w-4xl">
        <div className="text-center text-gray-500 animate-pulse dark:text-gray-400">
          Loading...
        </div>
      </div>
    );
      ...
      <div className="flex relative z-20 flex-col justify-center items-center px-4 pt-24 pb-20 min-h-screen">
        <div className="mx-auto w-full max-w-4xl">
          ...
          <div className="flex flex-wrap gap-4 items-center mb-6 text-sm">
            <span className="inline-flex gap-2 items-center px-3 py-1 font-medium text-cyan-800 bg-cyan-100 rounded-full dark:bg-cyan-900 dark:text-cyan-200">
              {renderIcon(Hash, { className: "w-4 h-4" })}
              {thread?.chatId || "Unknown"}
            </span>
            <span className="inline-flex gap-2 items-center px-3 py-1 font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-200">
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  <div className="flex gap-3 items-center">
                    ...
                    {message.messageType === "bot_message" && (
                      <span className="inline-flex gap-2 items-center px-2 py-1 text-xs font-medium text-purple-200 rounded-full bg-purple-900/50">
          ...
          {thread?.isActive && (
            <Card className="mt-6 bg-gray-900/90 border-gray-700/50">
              ...
              <form onSubmit={handleSendMessage} className="space-y-4">
                ...
                {error && (
                  <div className="flex gap-2 items-center p-4 font-medium text-red-200 rounded-xl border bg-red-900/50 border-red-700/50">
