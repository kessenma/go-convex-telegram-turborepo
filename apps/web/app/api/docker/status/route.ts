...
export async function GET() {
  try {
    ...
    const dockerStatus = {
      ...
      status: "healthy",
      ready: true,
      message: `${process.env.NEXT_PUBLIC_TOTAL_RAM_ALLOCATED || '10.384G'} ram allocated`,
      services: [
        {
          name: "web-dashboard",
          status: "running",
        ...
        },
        {
          ...
          status: "running",
          health: "healthy",
          port: process.env.NEXT_PUBLIC_NEXT_PUBLIC_CONVEX_PORT || "3210",
          uptime: "2h 15m",
          restarts: 0,
        },
        {
        ...
        },
        {
          ...
          status: "running",
          health: "healthy",
          port: process.env.NEXT_PUBLIC_LIGHTWEIGHT_LLM_PORT || "8082",
          uptime: "2h 15m",
          restarts: 0,
        },
        {
