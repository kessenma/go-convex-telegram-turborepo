      ...
      <div className="px-4 mx-auto max-w-4xl">
        ...
        <div className="p-6 bg-gray-800 rounded-lg border border-gray-700">
          <div className="flex items-center mb-6">
            <div className={`p-3 rounded-lg mr-4 ${document.contentType === 'markdown' ? 'bg-curious-cyan-900 text-curious-cyan-300' : 'bg-gray-700 text-gray-300'}`}>
              {renderIcon(FileText, { className: "w-6 h-6" })}
            </div>
            <div>
              <h1 className="mb-1 text-2xl font-semibold text-white">{document.title}</h1>
