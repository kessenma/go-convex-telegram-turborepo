...
export function useDocumentOperations(limit: number = 10) {
  ...
  const displayDocuments = storeDocuments.length > 0 ? storeDocuments : documents;
  ...
  }, [documents, statsQuery, loadingDocuments, loadingStats, setDocuments, setStats, setLoading]);
