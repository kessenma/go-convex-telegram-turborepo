...
import { Terminal, CommandLine, OutputLine, Loading, TypingAnimation } from '../terminal';
...
export function SetupScriptDemo({ className, autoStart = false, isVisible = false }: SetupScriptDemoProps) {
  ...
  const steps: Step[] = [
    ...
    {
      type: 'output',
      content: 'Enter your Telegram bot token: 7***************:AAH***************************',
      delay: 1200,
      outputType: 'warning' as const
    },
    {
            ...
            {isComplete && (
              ...
              >
                ...
                <ul className="text-xs space-y-1 text-green-300">
                  <li>• Configured environment variables with your bot credentials</li>
