...
export function DeployApiDemo({ className, autoStart = false, isVisible = false }: DeployApiDemoProps) {
  ...
  const steps: Step[] = [
    ...
    {
      type: 'output',
      content: '✅ API file successfully deployed to apps/web/generated-convex.ts',
      delay: 1000,
        ...
        {currentStep === -1 ? (
          ...
          <div>
            ...
            {isComplete && (
              ...
              >
                <div className="font-medium mb-1">🎯 API Generation Benefits:</div>
