...
const dockerServices: DockerService[] = [
  {
    ...
    detailedDescription:
      "Central database and API server. Handles all data operations, user management, and real-time synchronization across the platform. Acts as the backbone of the entire system architecture.",
  ...
  },
  {
    ...
    detailedDescription:
      "Modern React-based web application built with Next.js. Provides the main user interface for document upload, chat interactions, and system management with server-side rendering capabilities.",
  ...
  },
  {
    ...
    detailedDescription:
      "Lightweight AI language model service that provides intelligent responses and chat capabilities. Handles natural language processing and generation for seamless user interactions.",
    animationDirection: "left",
  },
  {
    ...
    detailedDescription:
      "Converts text into vector embeddings after upload so LLM apps can parse their database semantically + efficiently.",
    animationDirection: "right",
  },
  {
    ...
    detailedDescription:
      "Golang-powered Telegram bot that enables users to interact with the system through Telegram messages. Handles file uploads, chat commands, and provides mobile-first access.",
    animationDirection: "left",
  },
  {
    name: "convex-console",
    ...
    detailedDescription:
      "Administrative interface for monitoring and managing the Convex backend. Provides insights into database operations, system health, and real-time analytics.",
    animationDirection: "right",
  },
];
...
export function ThreeTimeline({
  ...
  const [showAllDescriptions, _setShowAllDescriptions] = useState(false);
  ...
  useEffect(() => {
    ...
    const createSphere = (radius: number, _color: number) => {
    ...
    if (
      ...
      cubesRef.current.forEach((cube, index) => {
        ...
        if (connectionsRef.current[index]) {
          cubeTl.to(
            connectionsRef.current[index].material,
            {
              opacity: 0.7,
              duration: 0.2,
            },
      ...
      if (
        ...
        turborepoCircleRef.current &&
        finalSphereRef.current
      ) {
        ...
        circlesTl
          ...
          .to(
            dockerCircleRef.current.rotation,
            {
              z: Math.PI * 6,
              duration: 3,
              ease: "none",
          ...
          .to(
            turborepoCircleRef.current.material,
            {
              opacity: 0.7,
              duration: 0.8,
              ease: "power2.out",
          ...
          .to(
            turborepoCircleRef.current.rotation,
            {
              z: -Math.PI * 6,
              duration: 3.5,
              ease: "none",
          ...
          .to(
            turborepoLabelRef.current?.style || {},
            {
              opacity: 1,
              duration: 0.5,
            },
        ...
        circlesTl
          ...
          // Hide service labels
          .to(
            labelsRef.current.map((label) => label?.style).filter(Boolean),
            {
              opacity: 0,
              duration: 0.3,
            },
          ...
          .to(
            cubesRef.current.map((cube) => cube?.position).filter(Boolean),
            {
              x: 0,
              y: 0,
              z: 0,
          ...
          .to(
            cubesRef.current.map((cube) => cube?.scale).filter(Boolean),
            {
              x: 0.6,
              y: 0.6,
              z: 0.6,
          ...
          .to(
            finalSphereRef.current.material,
            {
              opacity: 0.6,
              duration: 1.0,
              ease: "power2.out",
          ...
          .to(
            finalSphereRef.current.position,
            {
              x: 0,
              y: 0,
              z: 0,
    ...
    const animate = () => {
      ...
      if (
        ...
        ((Array.isArray(dockerCircleRef.current.material) &&
          dockerCircleRef.current.material.some(
            (m) => "opacity" in m && m.opacity < 0.2
          )) ||
          (!Array.isArray(dockerCircleRef.current.material) &&
      ...
      <div className="relative z-10 pointer-events-none">
        ...
        <section className="flex justify-end items-center pr-8 h-screen">
          <div className="max-w-md text-right text-white pointer-events-auto">
            ...
            <p className="text-sm">
              The central hub managing all data operations and real-time
              synchronization
            </p>
          </div>
        </section>
        ...
        <section className="flex justify-start items-center pl-8 h-screen">
          <div className="max-w-md text-left text-white pointer-events-auto">
            ...
            <p className="text-sm">
              Modern React application providing the main user interface
            </p>
          </div>
        </section>
        ...
        <section className="flex justify-center items-start pt-16 h-screen">
          <div className="max-w-md text-center text-white pointer-events-auto">
            ...
            <p className="text-sm">
              LLM and Vector processing services for intelligent interactions
            </p>
          </div>
        </section>
        ...
        <section className="flex justify-center items-end pb-16 h-screen">
          <div className="max-w-md text-center text-white pointer-events-auto">
            ...
            <p className="text-sm">
              Telegram bot and admin console for external interactions
            </p>
          </div>
        </section>
        ...
        <section className="flex justify-center items-center h-screen">
          <div className="text-center text-white pointer-events-auto">
            ...
            <p className="text-sm">
              Everything converges into a single, cohesive unit
            </p>
          </div>
        </section>
        ...
        <section className="flex justify-center items-center h-screen">
          <div className="text-center text-white pointer-events-auto">
            ...
            <p className="text-sm">
              Your microservices architecture visualization
            </p>
          </div>
        </section>
      </div>
